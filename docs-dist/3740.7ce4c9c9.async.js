"use strict";(self.webpackChunktiger_ui=self.webpackChunktiger_ui||[]).push([[3740],{3740:function(t,n,e){e.r(n),e.d(n,{default:function(){return i}});var i=[Object.freeze({fileTypes:["vhd","vhdl","vho","vht"],name:"vhdl",patterns:[{include:"#block_processing"},{include:"#cleanup"}],repository:{architecture_pattern:{patterns:[{begin:`(?x)
